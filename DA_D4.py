import pandas as pd
Data = {
    "Name":["Ansh","Shiva","Lucky","Nadeem","yash","Priyesh","Anuj","yash"],
...
#print(df)
#df.to_csv('Ansh_data.csv')
#print(df[['Name','Salary']])
#print(df.loc[(df.Name == 'Ansh')])

#print(df.loc[(df['Name'] == 'Ansh') & (df['Salary'] <= 30000)])

#filtered = df[(df['Name'] == 'Ansh') & (df['Salary'] >= 25000)]
#print(filtered)
...
#Add new column
# df['Team'] = ['CEO','HR','Accountant','Marketing','Boss','Developer','HR','Sales']
# print(df)
...
# df.to_csv('update_Ansh_data.csv')
#print(df)

# remove = df.drop(df[df.Name == 'yash'].index)
